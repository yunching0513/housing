    ...
    reading = [
        {'h': '兩種空屋不要混用',
         'p': f"普查問住戶「現在有沒有在用」，得到{n_hou['vacancy']}%；"
              f"內政部看電表每月60度以下，得到{n_moi['rates'][last]}%。"
              '兩者在極端一致、中段分歧，等級相關只有0.50，不要相減。'},
        {'h': '期別不一致是合併的代價',
         'p': '七份資料橫跨109到115年。同一份資料內的比較安全，跨資料比較要先看期別；'
              '每一頁都標了自己的資料期。'},
        {'h': '名次不等於好壞',
        ...
        {'h': '信令數的是手機不是人',
         'p': '一人兩支手機是兩個人，沒有手機的小孩與長輩是零個人。'
              f"桃園大園區的信令夜間人口是普查常住的2.73倍，因為那裡是機場。"},
        {'h': '承諾不是存量',
